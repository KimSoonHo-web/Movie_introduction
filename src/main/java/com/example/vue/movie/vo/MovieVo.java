package com.example.vue.movie.vo;
...
public class MovieVo {
	  ...
	  private int id; // 고유 ID
		...
		public MovieVo(int id, String title, String overview, String posterPath, int releaseDate, String country,
				float rating) {
			super();
			this.id = id;
			this.title = title;
		...
		public String toString() {
			return "MovieVo [id=" + id + ", title=" + title + ", overview=" + overview + ", posterPath=" + posterPath
